...
## Notre présentateur
Notre présentateur lors de la conférence est Monsieur Martin Boucher, un technicien en multimédia dans le Musée de l'ingéniosité J.Armand-Bombardier. Il a étudié en motion design et en musique.
...
Le matériel utilisé inclut des Raspberry Pi et différents logiciels tels que Arduino, After Effects ou Max MSP. 
...
Pendant la conférence, Monsieur Boucher à présenté certaines salles dans le musée. Il y avait notamment une salle de création de petits véhicules, une salle où il est possible de prendre des photos avec une motoneige antique, un fab lab, le garage Bombardier et une des bases de train de métro que J.Armand-Bombardier a créé.

La base de de train de métro comprend une installation interactive qui explique comment le son qu'on entend lorsqu'on utilise le métro a été créé. Il comporte un écran avec plusieurs boutons et des animations. Cette installation interactive à été créée pour pouvoir garder plus longtemps l'attention des visiteurs sur la base de train.
...
![Garage du Musée de l'ingéniosité J. Armand-Bombardier](media/Garage_musée_de_ingéniosité_JArmand-Bombadier.jpg)
